...
@pytest.mark.parametrize('delivery_data', test_delivery_data)
def test_delivery_data_functionality_with_valid_data(driver, valid_user_credentials, delivery_data):
...
@pytest.mark.delivery_data
@pytest.mark.parametrize("delivery_data", test_delivery_data)
def test_delivery_data_functionality_with_empty_firstname(driver, valid_user_credentials, delivery_data):
    login_page = UserInteractions(driver)
    login_page.open()
    login_page.login(*valid_user_credentials)
    login_page.click(MainPageLocators.cart_icon)
...
@pytest.mark.delivery_data
@pytest.mark.parametrize("delivery_data", test_delivery_data)
def test_delivery_data_functionality_with_empty_surname(driver, valid_user_credentials, delivery_data):
    login_page = UserInteractions(driver)
    login_page.open()
    login_page.login(*valid_user_credentials)
    login_page.click(MainPageLocators.cart_icon)
...
@pytest.mark.delivery_data
@pytest.mark.parametrize("delivery_data", test_delivery_data)
def test_delivery_data_functionality_with_empty_postal_code(driver, valid_user_credentials, delivery_data):
    login_page = UserInteractions(driver)
    login_page.open()
    login_page.login(*valid_user_credentials)
    login_page.click(MainPageLocators.cart_icon)
...
@pytest.mark.delivery_data
@pytest.mark.parametrize("delivery_data", test_delivery_data)
def test_delivery_data_functionality_with_empty_firstname_and_surname(driver, valid_user_credentials, delivery_data):
    login_page = UserInteractions(driver)
    login_page.open()
    login_page.login(*valid_user_credentials)
    login_page.click(MainPageLocators.cart_icon)
...
@pytest.mark.delivery_data
@pytest.mark.parametrize("delivery_data", test_delivery_data)
def test_delivery_data_functionality_with_empty_surname_and_postal_code(driver, valid_user_credentials, delivery_data):
    login_page = UserInteractions(driver)
    login_page.open()
    login_page.login(*valid_user_credentials)
    login_page.click(MainPageLocators.cart_icon)
...
@pytest.mark.delivery_data
@pytest.mark.parametrize("delivery_data", test_delivery_data)
def test_delivery_data_functionality_with_empty_firstname_and_postal_code(driver, valid_user_credentials, delivery_data):
    login_page = UserInteractions(driver)
    login_page.open()
    login_page.login(*valid_user_credentials)
    login_page.click(MainPageLocators.cart_icon)
