...
def test_adding_1_item_to_cart(driver, username, password):
    ...
    assert check_counter.shopping_card_badge_counter == "1", "The cart counter is not the same as expected"
