...
def test_adding_3_item_to_cart(driver, username, password):
    ...
    login_page.click(MainPageAddingButtonLocators.third_item_button)
    check_counter = MainPageAddingButtons(driver)

    assert check_counter.shopping_card_badge_counter == "3", "The cart counter is not the same as expected"
