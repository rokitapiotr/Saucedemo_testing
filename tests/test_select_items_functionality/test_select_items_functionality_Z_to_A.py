...
def test_select_items_functionality_high_to_low(driver, username, password):
    ...
    assert selected_option.expected_div_text_high_to_low == 'Sauce Labs Fleece Jacket', 'First item is not the same as expected '
